...
using LinearDataStructures.Extensions;

namespace LinearDataStructures.Tests
{
	[TestClass]
	public class DSAExtensionsTests
	{
		[TestMethod]
		...
		public void ListsAreEqual(int[] array1, int[] array2, bool expected)
		{
			...
			// Act
			var result = DSAExtensions.AreListsEqual(list1, list2);
		...
		public void FindMiddleNode(int[] array, int expected)
		{
			...
			// Act
			var middle = DSAExtensions.FindMiddleNode(list);
		...
		public void MergeSortedLists(int[] arr1, int[] arr2, int[] arrExpected)
		{
			...
			// Act
			var mergedList = DSAExtensions.MergeLists(list1, list2);

			// Assert
			Assert.IsTrue(DSAExtensions.AreListsEqual(mergedList, expectedList));
		}
		...
		public void ReverseList(int[] test, int[] expected)
		{
			...
			// Act
			var reversedList = DSAExtensions.ReverseList(inputList);

			// Assert
			Assert.IsTrue(DSAExtensions.AreListsEqual(reversedList, expectedList));
		}
		...
		public void ValidateParentheses(string expression, bool expected)
		{
			// Arrange
			// Act
			bool actual = DSAExtensions.AreValidParentheses(expression);
		...
		public void RemoveBackspaces(string sequence, char backspaceChar, string expected)
		{
			// Arrange
			// Act
			string actual = DSAExtensions.RemoveBackspaces(sequence, backspaceChar);
